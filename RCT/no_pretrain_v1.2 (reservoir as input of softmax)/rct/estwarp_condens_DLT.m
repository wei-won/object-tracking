function param = estwarp_condens_DLT(frm, tmpl, param, opt, nn, frameNum, RC)
...
dataorig = data; % data before RC

dataStateCollection = compute_statematrix(data, [], RC, 0);
data = dataStateCollection(:,1 : RC.nInternalUnits)';
...
param.wimg = reshape(dataorig(:,maxidx), sz);
